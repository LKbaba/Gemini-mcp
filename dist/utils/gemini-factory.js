 ...
 */
function fixWindowsSlashCorruption(credentials) {
 ...
 */
function setupCredentialsTempFile(credentials) {
 ...
 */
export function createGeminiAI(config) {
 ...
 */
function detectRawServiceAccountEnv() {
 ...
 */
export function detectAuthConfig() {
    ...
    throw new Error('No authentication configured. Set one of:\n' +
